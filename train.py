...
def train(hyp, opt, device, tb_writer=None):
    ...
    if pretrained:
        ...
        ckpt = torch.load('./yolov7.pt', map_location=device)  # load checkpoint
...
if __name__ == '__main__':
    ...
    parser.add_argument('--quad', default=True, action='store_true', help='quad dataloader')
    parser.add_argument('--linear-lr', default=True, action='store_true', help='linear LR')
    parser.add_argument('--label-smoothing', type=float, default=0.1, help='Label smoothing epsilon')
    parser.add_argument('--upload_dataset', action='store_true', help='Upload dataset as W&B artifact table')
    parser.add_argument('--bbox_interval', type=int, default=-1, help='Set bounding-box image logging interval for W&B')
    parser.add_argument('--save_period', type=int, default=-1, help='Log model after every "save_period" epoch')
    parser.add_argument('--artifact_alias', type=str, default="latest", help='version of dataset artifact to be used')
    parser.add_argument('--freeze', nargs='+', type=int, default=[50], help='Freeze layers: backbone of yolov7=50, first3=0 1 2')
